        ...
        <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php $handler->html_input(['label' => 'E-naslov', 'name' => 'email', 'value' => (!empty($data->email)) ? $data->email : '', 'required' => false]); ?>                            
                    <?php $handler->html_input(['label' => 'Telefon', 'name' => 'telefon', 'value' => (!empty($data->telefon)) ? $data->telefon : '', 'required' => false]); ?>                            
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
