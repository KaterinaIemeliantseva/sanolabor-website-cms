        ...
        <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php $handler->html_input(['label' => 'Povezava', 'name' => 'povezava', 'value' => (!empty($data->povezava)) ? $data->povezava : '', 'required' => false]); ?>      
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="padding-left:0;">
                                <?php $handler->html_input(['name' => 'datum_od', 'value' => (!empty($data->datum_od)) ? $data->datum_od : '', 'required' => false, 'datepicker' => true]); ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="vertical-align: middle;">
                            ...
                            <td style="padding-left:0px;">
                                <?php $handler->html_input(['name' => 'datum_do', 'value' => (!empty($data->datum_do)) ? $data->datum_do : '', 'required' => false, 'datepicker' => true]); ?>
                            </td>
                        </tr>
                    </table>  
