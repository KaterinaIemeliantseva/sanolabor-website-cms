    ...
    <div class="tab-content default-tab active" id="tab1">
        <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
            <div class="row">
                ...
                <?php //$handler->html_input(['label' => 'Povezava', 'name' => 'url', 'value' => (!empty($data->url)) ? $data->url : '', 'required' => false]); ?>  
                <?php $handler->html_single_file_upload(['label' => 'mp3', 'name' => 'pot', 'value' => (!empty($data->pot)) ? $data->pot : '', 'required' => false]); ?>  
