        ...
        <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?php $handler->html_input(['label' => 'Objavi od', 'name' => 'datum_od', 'value' => (!empty($data->datum_od)) ? $data->datum_od : '', 'required' => false, 'datepicker' => true]); ?>    
                    <?php $handler->html_input(['label' => 'Objavi do', 'name' => 'datum_do', 'value' => (!empty($data->datum_do)) ? $data->datum_do : '', 'required' => false, 'datepicker' => true]); ?>    
                </div>
                <div class="col-lg-6">  
                    <?php $handler->html_editor(['label' => 'Opis', 'name' => 'opis', 'height' => '150', 'value' => (!empty($data->opis)) ? $data->opis : '']); ?>                    
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
