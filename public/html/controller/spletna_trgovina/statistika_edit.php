...
<div class="row" id="stat_table">
    <div class="col-lg-5">
        <table class="stat_table">
            <tr><td><strong>Vsota nakupov po načinu plačila</strong></td><td></td></tr>
            <tr><td >Plačilo po povzetju:</td> <td><?php echo number_format($placilo_po_povzetju['znesek_skupaj'], 2, ',', '.'); ?> €</td></tr>
            <tr><td>Plačilo po predračunu:</td> <td><?php echo number_format($placilo_predracun['znesek_skupaj'], 2, ',', '.'); ?> €</td></tr>
            <tr><td>Plačilo s plačilno kartico:</td> <td><?php echo number_format($placilo_kreditna_kartica['znesek_skupaj'], 2, ',', '.'); ?> €</td></tr>

            <tr class="noExl"><td colspan="2"><div style="border-bottom:1px solid #000;"></div></td></tr>
            <tr><td><strong>Skupaj:</strong></td> <td><?php echo number_format( (($placilo_kreditna_kartica['znesek_skupaj']) + ($placilo_po_povzetju['znesek_skupaj']) + ($placilo_predracun['znesek_skupaj']) ), 2, ',', '.' ) ; ?> €</td></tr>
            <tr><td ></td><td></td></tr>
        </table>
        <br /><br />
        <table class="stat_table">
            <tr><td><strong>Število nakupov po načinu plačila</strong></td><td></td></tr>
            <tr><td >Plačilo po povzetju:</td> <td><?php echo ($placilo_po_povzetju['stevilo_nakupov']); ?> </td></tr>
            <tr><td>Plačilo po predračunu:</td> <td><?php echo ($placilo_predracun['stevilo_nakupov']); ?> </td></tr>
            <tr><td>Plačilo s plačilno kartico:</td> <td><?php echo ($placilo_kreditna_kartica['stevilo_nakupov']); ?> </td></tr>
       
            <tr class="noExl"><td colspan="2"><div style="border-bottom:1px solid #000;"></div></td></tr>
            <tr><td><strong>Skupaj:</strong></td> <td><?php echo (($placilo_kreditna_kartica['stevilo_nakupov']) + ($placilo_po_povzetju['stevilo_nakupov']) + ($placilo_predracun['stevilo_nakupov']) ); ?> </td></tr>
            <tr><td ></td><td></td></tr>
        </table>
        <br /><br />

        <?php 
        $nakup_registracija = $foo->getNarociloPoNacinuNakupa(2, $from, $to);
        $nakup_hitri = $foo->getNarociloPoNacinuNakupa(3, $from, $to);
        ?>
        <table class="stat_table">
            <tr><td ><strong>Vsota vrednosti nakupov po načinu nakupa</strong></td><td></td></tr>
            <tr><td>Registracije:</td> <td><?php echo number_format($nakup_registracija['znesek_skupaj'], 2, ',', '.'); ?> € </td></tr>
            <tr><td>Hitri nakup:</td> <td><?php echo number_format($nakup_hitri['znesek_skupaj'], 2, ',', '.'); ?> € </td></tr>

            <tr class="noExl"><td colspan="2"><div style="border-bottom:1px solid #000;"></div></td></tr>
            <tr><td><strong>Skupaj:</strong></td> <td><?php echo number_format( ( + ($nakup_registracija['znesek_skupaj']) + ($nakup_hitri['znesek_skupaj']) ), 2, ',', '.' ) ; ?> € </td></tr>
            <tr><td ></td><td></td></tr>
        </table>
        <br /><br />

        <table class="stat_table">
            <tr><td ><strong>Število nakupov po načinu nakupa</strong></td><td></td></tr>
    
            <tr><td>Registracije:</td> <td><?php echo ($nakup_registracija['stevilo_nakupov']); ?> </td></tr>
            <tr><td>Hitri nakup:</td> <td><?php echo ($nakup_hitri['stevilo_nakupov']); ?> </td></tr>

            <tr class="noExl"><td colspan="2"><div style="border-bottom:1px solid #000;"></div></td></tr>
            <tr><td><strong>Skupaj:</strong></td> <td><?php echo ( ($nakup_registracija['stevilo_nakupov']) + ($nakup_hitri['stevilo_nakupov']) ); ?> </td></tr>
            <tr><td ></td><td></td></tr>
        </table>

        <br /><br />
        <?php $osebni_prevzem = $foo->getNarociloPoNacinuNakupa(5, $from, $to); ?>
        <table class="stat_table">
            <tr><td ><strong>Osebni prevzem</strong></td><td></td></tr>
            <tr class="noExl"><td colspan="2"><div style="border-bottom:1px solid #000;"></div></td></tr>
            <tr><td ><strong>Skupaj:</strong></td><td><?php echo ($osebni_prevzem['stevilo_nakupov']); ?></td></tr>
            <tr><td ></td><td></td></tr>
            <tr><td ></td><td></td></tr>
        </table>
    </div>
    <div class="col-lg-7">
        ...
        <table class="stat_table" id="table">
