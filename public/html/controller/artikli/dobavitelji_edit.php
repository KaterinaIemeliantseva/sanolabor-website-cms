...
<div class="content-box-content">
    <div class="tab-content default-tab active" id="tab1">
        <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
            <div class="row">
                <div class="col-lg-12">
                    <?php $handler->html_input(['label' => 'Naziv', 'name' => 'name', 'value' => (!empty($data->name)) ? $data->name : '', 'required' => true]); ?>                            
                    <?php $handler->html_input(['label' => 'Uporabniško ime', 'name' => 'username', 'value' => (!empty($data->username)) ? $data->username : '', 'required' => true]); ?>                            
                    <?php $handler->html_input(['label' => 'Geslo', 'name' => 'password', 'value' => '', 'required' => (!$data), 'custom' => 'minlength="6"']); ?>                        
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
