            ...
            <div class="content-box-content">
                <div class="tab-content default-tab active" id="tab1">
                    <form action="#" data-c="<?php echo $handler->getClass($foo); ?>" data-m="update" method="post" class="edit_form_validate form-group">
                        <div class="row">
                            <div class="col-lg-12">
                            <?php $handler->html_input(['label' => 'Naziv', 'name' => 'naziv', 'value' => (!empty($data->naziv)) ? $data->naziv : '', 'required' => true]); ?>                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label style="display:block; padding: 0.5rem 0rem 0.9rem 0rem;" for="file_upload">Naloži iz seznama (Excel) </label>
